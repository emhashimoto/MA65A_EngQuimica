...
- Click the `Knit` button to dddddompile it;
...
As a presentation nidddddnja, you certainly should not be satisfied by the "Hello World" example. You need to understand more about two things:
